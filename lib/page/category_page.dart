...
import 'package:quiz_app_task/widget/question_numbers_widget.dart';
import 'package:quiz_app_task/widget/questions_widget.dart';
import 'package:quiz_app_task/model/option.dart';
...
class _CategoryPageState extends State<CategoryPage> {
  ...
  void selectOption(Option? option) { // Change Option to Option?
    if (question.isLocked || option == null) {
      return;
    } else {
      setState(() {
